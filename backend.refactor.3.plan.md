...
26. finir la migration des composants opportunity qui lisent encore `opportunity`, `email`, `participant` en direct
27. centraliser les agregats source/document/participant cote backend
