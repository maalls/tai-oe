...
const DEFAULT_COLLECTION = 'test_commerce_vectors';
...
async function loadCollections() {
   ...
   try {
      ...
      const hasSelection =
         !!selectedCollection.value && collections.value.includes(selectedCollection.value);
      if (!hasSelection) {
         const preferred = collections.value.includes(DEFAULT_COLLECTION)
            ? DEFAULT_COLLECTION
            : collections.value[0];
         if (preferred) {
