...
| `vendor get` (`/api/vendor`)                                                                          | retired from legacy DDD route map              | `src/api_fastapi/vendor/*`      | `fastapi` | `tests/unit/api_fastapi/vendor/router/test_vendor_routes.py`                                                    |
| `opportunity get/advance` (`/api/opportunity`, `/api/opportunity/advance`)                           | retired from legacy DDD route maps             | `src/api_fastapi/opportunity/*` | `fastapi` | `tests/unit/api_fastapi/opportunity/router/test_opportunity_routes.py`                                          |
| `rfp get/submit` (`/api/rfp`, `/api/rfp/submit`)                                                     | retired from legacy DDD route maps             | `src/api_fastapi/rfp/*`         | `fastapi` | `tests/unit/api_fastapi/rfp/router/test_rfp_routes.py`                                                          |
