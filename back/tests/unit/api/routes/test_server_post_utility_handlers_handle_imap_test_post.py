from src.api.routes.server_post_utility_handlers import handle_imap_test_post


class _RequestHandlersStub:
    def handle_imap_test(self, user_id):
...
def test_handle_imap_test_post_uses_authenticated_user_id():
    handler = _HandlerStub()

    result = handle_imap_test_post(handler)
