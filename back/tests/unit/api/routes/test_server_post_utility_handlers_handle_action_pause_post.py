...
class _RequestHandlersStub:
    def handle_pause_action(self, action_id, user_id):
...
def test_handle_action_pause_post_forwards_action_id_and_user_id():
    handler = _HandlerStub()

    result = handle_action_pause_post(handler, _MatchStub())
