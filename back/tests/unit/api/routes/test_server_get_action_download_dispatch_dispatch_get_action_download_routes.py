...
def test_dispatch_get_action_download_routes_delegates_action_router(monkeypatch):
    ...
    monkeypatch.setattr("src.api.routes.server_get_action_download_dispatch.dispatch_action_routes", _fake)
...
def test_dispatch_get_action_download_routes_delegates_quote_router(monkeypatch):
    monkeypatch.setattr(
        "src.api.routes.server_get_action_download_dispatch.dispatch_action_routes",
    ...
    monkeypatch.setattr("src.api.routes.server_get_action_download_dispatch.dispatch_quote_routes", _fake)
...
def test_dispatch_get_action_download_routes_delegates_document_router(monkeypatch):
    ...
    monkeypatch.setattr(
        "src.api.routes.server_get_action_download_dispatch.dispatch_quote_routes",
        lambda *_args, **_kwargs: False,
    )
    calls = []
    ...
    monkeypatch.setattr("src.api.routes.server_get_action_download_dispatch.dispatch_document_routes", _fake)
