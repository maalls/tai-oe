...
def test_dispatch_get_misc_routes_delegates_product_router(monkeypatch):
    ...
    monkeypatch.setattr("src.api.routes.server_get_misc_dispatch.dispatch_product_routes", _fake)
...
def test_dispatch_get_misc_routes_delegates_file_router(monkeypatch):
    monkeypatch.setattr(
        "src.api.routes.server_get_misc_dispatch.dispatch_product_routes",
    ...
    monkeypatch.setattr("src.api.routes.server_get_misc_dispatch.dispatch_file_routes", _fake)
