from src.api.routes.server_post_utility_handlers import handle_email_senders_verified_post


class _RequestHandlersStub:
    def handle_get_verified_senders(self, user_id):
...
def test_handle_email_senders_verified_post_uses_authenticated_user_id():
    handler = _HandlerStub()

    result = handle_email_senders_verified_post(handler)
