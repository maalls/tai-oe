...
from src.api.routes import server_post_auth_dispatch
...
def test_dispatch_post_auth_routes_login(monkeypatch):
    ...
    monkeypatch.setattr(server_post_auth_dispatch, "dispatch_auth_routes", _fake_dispatch_auth_routes)
...
def test_dispatch_post_auth_routes_unknown_path(monkeypatch):
    ...
    monkeypatch.setattr(server_post_auth_dispatch, "dispatch_auth_routes", lambda h, m, p, q: False)
