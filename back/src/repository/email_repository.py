...
class EmailRepository:
    ...
    def store_email(self, **kwargs) -> Dict:
        """Persist an email through the infrastructure database adapter."""
        return self.db_handler.store_email(**kwargs)
