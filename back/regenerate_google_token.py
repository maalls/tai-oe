...
Usage:
  python regenerate_google_token.py              # Gmail token (default)
  python regenerate_google_token.py --type drive # Google Drive token
"""
...
def regenerate_drive_token():
    ...
    print("Deleting old token...")
    var_dir = Path(__file__).parent / "var" / "gdrive"
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python regenerate_google_token.py              # Regenerate Gmail token
  python regenerate_google_token.py --type drive # Regenerate Drive token
        """
    )
    parser.add_argument(
        "--type",
