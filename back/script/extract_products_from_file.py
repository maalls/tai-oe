...
Usage:
    python back/script/extract_products_from_file.py <path_to_file>

Example:
    python back/script/extract_products_from_file.py request.txt
    python back/script/extract_products_from_file.py request.pdf
"""
