...
- **Action** :
  ...
  - Créer sous-dossiers par domaine : `api/auth/`, `api/business/`, `api/action/`, `api/quote/`, `api/product/`, `api/csv/`, `api/file/`, `api/database/`, `api/prompt/`
